...
let pages = {
    ...
    "https://realmastertonky.github.io/site/roblox": function() {
		...
		document.body.innerHTML += `<div style="background-color:rgba(255,255,0,0.2)"><p style="font-size:30px">! inactive in roblox !</p><p>due to russian organization "роскомнадзор" (which is responsible for restricting internet in russia), i can't play roblox anymore, as they blocked the platform on the 3rd of december, 2025. Thanks Russia!</p></div>`
